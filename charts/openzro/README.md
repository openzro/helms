...
![Version: 2.1.0-alpha.67](https://img.shields.io/badge/Version-2.1.0--alpha.67-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.53.1-alpha.83](https://img.shields.io/badge/AppVersion-0.53.1--alpha.83-informational?style=flat-square)
...
| dashboard.deploymentAnnotations | object | `{}` |  |
...
| dashboard.livenessProbe.initialDelaySeconds | int | `5` |  |
| dashboard.livenessProbe.periodSeconds | int | `10` |  |
| dashboard.livenessProbe.timeoutSeconds | int | `3` |  |
| dashboard.nodeSelector | object | `{}` |  |
| dashboard.pdb.enabled | bool | `true` |  |
| dashboard.pdb.maxUnavailable | string | `""` |  |
...
| dashboard.readinessProbe.timeoutSeconds | int | `3` |  |
...
| dashboard.startupProbe.failureThreshold | int | `15` |  |
| dashboard.startupProbe.httpGet.path | string | `"/"` |  |
| dashboard.startupProbe.httpGet.port | string | `"http"` |  |
| dashboard.startupProbe.initialDelaySeconds | int | `5` |  |
...
| dex.image.tag | string | `"0.53.1-alpha.83"` |  |
...
| gatewayApi.routes.management.timeouts | object | `{}` |  |
...
| ingress.host | string | `""` |  |
| ingress.management.enabled | bool | `false` |  |
| ingress.management.path | string | `"/api"` |  |
| ingress.management.pathType | string | `"Prefix"` |  |
| ingress.tls | list | `[]` |  |
| management.affinity | object | `{}` |  |
| management.archiveCompaction.backoffLimit | int | `0` |  |
| management.archiveCompaction.bucket | string | `""` |  |
| management.archiveCompaction.concurrency | int | `1` |  |
| management.archiveCompaction.deleteOriginals | bool | `false` |  |
| management.archiveCompaction.enabled | bool | `false` |  |
| management.archiveCompaction.endpoint | string | `""` |  |
| management.archiveCompaction.env | object | `{}` |  |
| management.archiveCompaction.envFromSecret | object | `{}` |  |
| management.archiveCompaction.failedJobsHistoryLimit | int | `3` |  |
| management.archiveCompaction.lookbackDays | int | `2` |  |
| management.archiveCompaction.nodeSelector | object | `{}` |  |
| management.archiveCompaction.prefix | string | `""` |  |
| management.archiveCompaction.provider | string | `""` |  |
| management.archiveCompaction.region | string | `""` |  |
| management.archiveCompaction.resources.limits.cpu | string | `"2"` |  |
| management.archiveCompaction.resources.limits.memory | string | `"2Gi"` |  |
| management.archiveCompaction.resources.requests.cpu | string | `"200m"` |  |
| management.archiveCompaction.resources.requests.memory | string | `"512Mi"` |  |
| management.archiveCompaction.schedule | string | `"17 4 * * *"` |  |
| management.archiveCompaction.startingDeadlineSeconds | int | `3600` |  |
| management.archiveCompaction.successfulJobsHistoryLimit | int | `3` |  |
| management.archiveCompaction.suspend | bool | `false` |  |
| management.archiveCompaction.tmpSizeLimit | string | `"2Gi"` |  |
| management.archiveCompaction.tolerations | list | `[]` |  |
...
| management.pdb.enabled | bool | `true` |  |
| management.pdb.maxUnavailable | string | `""` |  |
| management.pdb.minAvailable | int | `1` |  |
...
| management.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| management.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| management.securityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
...
| management.startupProbe.failureThreshold | int | `30` |  |
| management.startupProbe.initialDelaySeconds | int | `5` |  |
| management.startupProbe.periodSeconds | int | `10` |  |
| management.startupProbe.tcpSocket.port | string | `"http"` |  |
...
| relay.pdb.enabled | bool | `true` |  |
| relay.pdb.maxUnavailable | string | `""` |  |
...
| relay.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| relay.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
...
| signal.readinessProbe.timeoutSeconds | int | `3` |  |
| signal.replicaCount | int | `1` |  |
| signal.resources | object | `{}` |  |
| signal.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| signal.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| signal.securityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
...
| signal.startupProbe.failureThreshold | int | `15` |  |
| signal.startupProbe.initialDelaySeconds | int | `5` |  |
| signal.startupProbe.periodSeconds | int | `5` |  |
