...
To install the chart with the release name `openzro`:
...
To uninstall/delete the `openzro` release:
...
The following table lists the configurable parameters of the openZro Helm chart and their default values.
...
| dashboard.image.repository | string | `"openzro/dashboard"` |  |
...
| management.image.repository | string | `"openzro/management"` |  |
...
| management.podCommand.args[4] | string | `"--single-account-mode-domain=openzro.selfhosted"` |  |
| management.podCommand.args[5] | string | `"--dns-domain=openzro.selfhosted"` |  |
...
| relay.image.repository | string | `"openzro/relay"` |  |
...
| signal.image.repository | string | `"openzro/signal"` |  |
